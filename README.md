...
- Nastavenie rozhrania pre praváka a ľaváka
- Výber z 10 jazykových lokalizácií aplikácie
- Automatické odosielanie e-mailov pri registrácii, zmene hesla a zmene e-mailovej adresy
- Integrácia mapových podkladov a lokalizačných služieb
...
Kompletné testovacie scenáre projektu sa nachádzajú v Excel súbore `Testovacie_scenare.xlsx`.
